...
get you started. [About the JavaScript](docs/js.mdjs.md).
...
[Read more about the `.editorconfig` file](docs/misc.mdsc.md#editorconfig).
...
refer to the [according documentation](docs/extend.mdnd.md#apple-touch-icons).
